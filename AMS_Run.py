...
def manually_fill():
    ...
    def fill_attendance():
        ...
        try:
            global cursor
            connection = pymysql.connect(host='localhost', user='root', password='1234', db='manually_fill_attendance')
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name=r'C:\Users\siric\OneDrive\Documents\Hactoberfest\temp\Attendace_management_system\Attendance\Manually Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'C:\Users\siric\OneDrive\Documents\Hactoberfest\temp\Attendace_management_system\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(host='localhost', user='root', password='1234', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='snow')
                cs = r"C:\Users\siric\OneDrive\Documents\Hactoberfest\temp\Attendace_management_system\\" + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'C:\Users\siric\OneDrive\Documents\Hactoberfest\temp\Attendace_management_system\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == '124' :
            if password == '124':
                ...
                cs = r'C:\Users\siric\OneDrive\Documents\Hactoberfest\temp\Attendace_management_system/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
